...
class Question:
    def __init__(self, difficulty="fundamental"):
        ...
        self.fund_phase1 = [
            ...
            {"question": "Um carro percorre 120 m em 4 s com velocidade \n"
             "constante. Qual a velocidade?", "options": ["A) 20 m/s", "B) 30 m/s", "C) 40 m/s", "D) 60 m/s"], "correct": 1},
            ...
            {"question": "Se um móvel possui velocidade de 10 m/s, quanto \n"
              "percorre em 5 s?", "options": ["A) 2 m", "B) 15 m", "C) 50 m", "D) 100 m"], "correct": 2},
            {"question": "O gráfico da posição em função do tempo no MU \n"
            "é uma:", "options": ["A) Reta inclinada.", "B) Parábola.", "C) Linha horizontal.", "D) Hipérbole."], "correct": 0}
        ]

        self.fund_phase2 = [
            {"question": "No MUV, o que muda a cada segundo?", "options": ["A) A massa.", "B) A aceleração.", "C) A velocidade.", "D) A trajetória."], "correct": 2},
            {"question": "Um veículo parte do repouso e atinge 20 m/s em 4 s. \n"
             "Qual a aceleração?", "options": ["A) 2 m/s²", "B) 4 m/s²", "C) 5 m/s²", "D) 10 m/s²"], "correct": 2},
            ...
            {"question": "No MUV, o gráfico da velocidade em função \n"
            " do tempo é uma:", "options": ["A) Reta inclinada.", "B) Parábola.", "C) Linha paralela ao eixo do tempo.", "D) Circunferência."], "correct": 0},
            {"question": "Um corpo em queda livre (sem resistência do ar) \n"
             "sofre a ação de qual força principal?", "options": ["A) A força magnética.", "B) A aceleração da gravidade.", "C) A força de atrito.", "D) A força centrífuga."], "correct": 1}
        ]

        self.fund_phase3 = [
            {"question": "Qual unidade do Sistema Internacional\n"
              "(SI) mede velocidade?", "options": ["A) km/h", "B) m/s", "C) cm/s", "D) mph"], "correct": 1},
            {"question": "Transformando 72 km/h para m/s, temos:", "options": ["A) 10 m/s", "B) 15 m/s", "C) 20 m/s", "D) 25 m/s"], "correct": 2},
            {"question": "Em física, o repouso ou o movimento de \n"
            " um corpo depende de:", "options": ["A) Do referencial adotado.", "B) Da temperatura.", "C) Da massa do objeto.", "D) Da cor do objeto."], "correct": 0},
            {"question": "Se um móvel tem aceleração constante de 3 m/s², \n"
            "sua velocidade a cada segundo aumenta em:", "options": ["A) 1 m/s", "B) 2 m/s", "C) 3 m/s", "D) 9 m/s"], "correct": 3},
        ...
        self.adv_phase1 = [
            ...
            {"question": "Dada a função horária S = -5 + 12t,em qual \n"
             "instante o móvel passa pela origem?", "options": ["A) t = 0,4 s", "B) t = 1,2 s", "C) t = 2,4 s", "D) t = 5,0 s"], "correct": 0},
        ...
        self.adv_phase3 = [
            {"question": "Um móvel com aceleração constante tem sua velocidade \n"
             "quadruplicada em 4 s (5 para 20 m/s). Qual a aceleração?", "options": ["A) 2,5 m/s²", "B) 3,75 m/s²", "C) 5,0 m/s²", "D) 7,5 m/s²"], "correct": 1},
